...
function HeadComponent(){
    ...
    return(
        <>
            <div id="nav" className=" bg-navbg font-fonts cursor-pointer  w-full h-24 flex justify-center">
                <div id="nav2" className=" border-2 mt-2 rounded-full w-4/5 p-4 flex justify-between items-center">
                    ...
                    <div id="menu-list"
                        className={`fixed top-5 right-96 w-44 h-auto bg-gray-800 text-white transform ${
